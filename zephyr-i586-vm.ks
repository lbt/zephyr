...
bootloader  --timeout=0  --append="quiet video=vesafb:mtrr:3 vga=864" 
user --name nemo  --groups audio,video --password nemo 

repo --name=mer-core --baseurl=http://releases.merproject.org/releases/0.20120920.0.1/builds/i586/packages --save --debuginfo
repo --name=ce-adaptation-x86-generic --baseurl=http://repo.pub.meego.com/CE:/Adaptation:/x86-generic/Mer_Core-next_i586/ --save
repo --name=zephyr --baseurl=http://repo.ci.merproject.org/home:/stskeeps:/zephyr/Core_i486/ --save
